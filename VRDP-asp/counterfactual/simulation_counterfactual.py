...
class Simulation():
    ...
    def __init__(self, ann_path, frame_params,  n_vis_frames=128, use_event_ann=True,use_IOD=False):
        ...
        if use_IOD:
            with open(os.path.join('../../NSDR-asp/data/converted',ann_path[-14:])) as f:
