...
def get_program(sim,question,choice,q_str,c_str,choices,args):
    ...
    answer_rule1='answer(Idx, Ans):- question(Ans,_,_), responsible(Idx).'
    answer_rule2='answer(Idx, Ans2):- question(Ans,_,_), not responsible(Idx),choice(Idx,_,_), neg(Ans,Ans2).'
